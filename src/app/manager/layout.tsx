...
const menuItems = [
  ...
  { href: '/manager/doctors', label: 'Médecins', icon: Stethoscope },
  { href: "/manager/patients", label: "Patients", icon: UserPlus },
  { href: "/manager/receptionist", label: "Réceptionnistes", icon: UserCheck },
];
